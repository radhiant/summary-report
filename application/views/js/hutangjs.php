...
$(document).ready(function() {
    ...
    table = $('#table-1').DataTable({
        ...
        "ajax": {
            "url": "<?php echo site_url('hutang/getDataHutangBank')?>",
            "type": "POST"
        },
    ...
    table1 = $('#table-2').DataTable({
        ...
        "ajax": {
            "url": "<?php echo site_url('hutang/getDataHutangVendor') ?>",
            "type": "POST"
        },
...
function konfirmasi(id) {
    ...
    swal.fire({
        ...
        if (result.value) {
            lodingklik();
            window.location.href = base_url + "hutang/proses_hapus/" + id;
        }
    });
...
function hapusBank() {
    ...
    swal.fire({
        ...
        if (result.value) {
            lodingklik();
            window.location.href = base_url + "hutang/hapus_all/bank";
        }
    });
...
function hapusVendor() {
    ...
    swal.fire({
        ...
        if (result.value) {
            lodingklik();
            window.location.href = base_url + "hutang/hapus_all/vendor";
        }
    });
...
function validateBank() {
    ...
    var namaH = document.forms["myForm"]["namaH"].value;
    var nilaiH = document.forms["myForm"]["nilaiH"].value;
    var cicilan = document.forms["myForm"]["cicilan"].value;
    var tglS = document.forms["myForm"]["tglS"].value;
    var tglF = document.forms["myForm"]["tglF"].value;

    if (idP == '') {
        validasi('Pilih Project!', 'warning');
        return false;
    } else if (namaH == '') {
        validasi('Nama Bank / Leasing wajib di isi!', 'warning');
        return false;
    } else if (cicilan == '') {
        validasi('Cicilan wajib di isi!', 'warning');
        return false;
    } else if (tglS == '') {
        validasi('Tanggal Start wajib di isi!', 'warning');
        return false;
    } else if (tglF == '') {
        validasi('Tanggal Finish wajib di isi!', 'warning');
        return false;
    }
...
function validateVendor() {
    ...
    if (idP == '') {
        ...
        validasi('Jatuh tempo wajib di isi!', 'warning');
        return false;
    }
