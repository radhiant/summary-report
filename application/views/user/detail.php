                ...
                <div class="card-body d-sm-flex">
                    <div class="col-lg-3">
                        <img width="100%" style="border-radius: 10px;"
                            src="<?= base_url() ?>assets/upload/pengguna/<?= $d->user_foto ?>">
                    </div>
                    ...
                    <div class="col-lg-9">
                        ...
                        <div class="form-group"><label>ID Pengguna</label>
                            <h4 class="h4 text-gray-800"><b><?= $d->user_id ?></b></h4>
                        </div>
                        ...
                        <div class="form-group"><label>Nama Lengkap</label>
                            <h4 class="h4 text-gray-800"><?= $d->user_nmlengkap ?></h4>
                        </div>
                        ...
                        <div class="form-group"><label>Username</label>
                            <h4 class="h4 text-gray-800"><?= $d->user_nama ?></h4>
                        </div>
                        ...
                        <div class="form-group"><label>Level</label>
                            <h4 class="h4 text-gray-800"><?= level($d->user_level) ?></h4>
                        </div>
                        ...
                        <div class="form-group"><label>Divisi</label>
                            <h4 class="h4 text-gray-800"><?= $d->user_divisi ?></h4>
                        </div>
