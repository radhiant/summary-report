    ...
    <input type="hidden" id="level" value="<?= $this->session->userdata('login_session')['level'] ?>">
            ...
            <div class="col-lg-12">
                <div class="card">
                    <div class="card-header">
                        <h4>Data Hutang Bank</h4>
                        <div class="card-header-action">
                            <a href="<?= base_url() ?>hutang/tambah/bank" class="btn btn-primary">Tambah <i
        ...
        <div class="row" id="vendor">
            <div class="col-lg-12">
                <div class="card">
                    <div class="card-header">
                        <h4>Data Hutang Vendor</h4>
                        <div class="card-header-action">
                            <a href="<?= base_url() ?>hutang/tambah/vendor" class="btn btn-primary">Tambah <i
                                    class="fas fa-plus"></i></a>
                        </div>
                    </div>
                    <div class="card-body">
